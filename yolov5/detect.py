    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                print("detecting_label",detecting_label)

                # ----------------------------------------------------#
                    # save detecting label .txt for database
                    
                if os.path.isfile("./save_detecting_label_folder"):
                    os.remove("./save_detecting_label_folder/ex.txt")
                else:
                    file = open("./save_detecting_label_folder/ex.txt","w")
                    # 꼬임
                    detecting_label = detecting_label.split()
                    detecting_label = detecting_label[0]
                    file.write(detecting_label)
                    file.close()
